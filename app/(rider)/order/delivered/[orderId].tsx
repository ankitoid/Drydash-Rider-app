...
//     try {
//       console.log("this is the deliveryy image",deliveryImage)
//       if (deliveryImage) {
...
//     // ✅ 3️⃣ THIS IS THE EXACT LINE YOU ADD
//     router.replace({
...
//         style={[
//           styles.summaryPrice,
//           { color: theme.text },bold && { fontWeight: "900" }
//         ]}
//       >
//         {price}
//       </Text>
...
export default function DeliveredOrderDetails() {
  ...
  const skipCapture = () => {
    // keep existing behavior: set a sentinel so uploadImage knows to skip actual upload
    setDeliveryImage("uri");
    setShowCamera(false);
    setShowConfirm(true);
  };
